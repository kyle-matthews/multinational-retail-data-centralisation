...
class DataExtractor:
        ...
        def extract_json_from_s3(self):
             s3 = boto3.client('s3')
             s3.download_file('data-handling-public', 'date_details.json', '/Users/kylematthews/Documents/AICore/multinational-retail-data-centralisation/multinational-retail-data-centralisation/date_details.json')
