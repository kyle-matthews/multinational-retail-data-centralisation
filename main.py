import pandas as pd
from python_classes.database_utils import DatabaseConnector
from python_classes.data_extraction import DataExtractor
from python_classes.data_cleaning import DataCleaning
...
legacy_users_df.to_csv("csv/extracted/extracted_users_data.csv")
clean_df = cleaner.clean_user_data(legacy_users_df)
clean_df.to_csv("csv/clean/clean_users_data.csv")
...
payment_data_df = pd.read_csv("csv/extracted/extracted_payment_data.csv")
clean_payment_data = cleaner.clean_card_data(payment_data_df)
clean_payment_data.to_csv("csv/clean/clean_payment_data.csv")
...
store_data_df = pd.read_csv("csv/extracted/extracted_store_data.csv")
cleaned_store_data_df = cleaner.clean_store_data(store_data_df)
cleaned_store_data_df.to_csv("csv/clean/clean_store_data.csv")
...
orders_df.to_csv("csv/extracted/extracted_orders.csv")
...
clean_orders_df.to_csv("csv/clean/clean_orders.csv")
...
print("extracted")
dim_date_times.to_csv("csv/extracted/extracted_date_times.csv")
print("csv'd")
clean_date_times = cleaner.clean_date_times(dim_date_times)
print("cleaned")
clean_date_times.to_csv("csv/clean/clean_date.csv")
print("clean_csv'd")
